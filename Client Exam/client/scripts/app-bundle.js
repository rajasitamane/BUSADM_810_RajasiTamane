...
define('modules/widgets',["exports", "aurelia-framework", "../resources/data/widget-object"], function (_exports, _aureliaFramework, _widgetObject) {
  ...
  var Todos = (_dec = (0, _aureliaFramework.inject)(_widgetObject.Todo), _dec(_class =
  /*#__PURE__*/
  function () {
    function Todos(todo) {
      this.todo = todo; //this.userObj = JSON.parse(sessionStorage.getItem('userObj'));
      ...
      return regeneratorRuntime.async(function getTodos$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return regeneratorRuntime.awrap(this.todo.getTodos());
...
define('resources/data/widget-object',["exports", "aurelia-framework", "./data-services"], function (_exports, _aureliaFramework, _dataServices) {
  ...
  function () {
    ...
    _proto.newTodo = function newTodo(id) {
      this.selectedTodo = {};
      this.selectedTodo.Boo = ""; //this.selectedTodo.Hoo = "";
      // this.selectedTodo.todo = "";
      // this.selectedTodo.detail = "";

      this.selectedTodo.Hoo = new Date(); // this.selectedTodo.status = "Todo";
